...
namespace TestHL7Enumerator
{
    ...
    public class UnitTestHL7Enumerator
    {
        ...
        {
            Assert.Equal(Example1 + OBXBase64Escaped,
                HL7Enumerator.HL7Message.EscapeOBXCRLF(Example1 + OBXBase64));
            Assert.Equal(Example1 + OBXBase64Escaped + OBXBase64Escaped + ExampleOBX,
        ...
        {
            Assert.Equal(Example1 + OBXBase64Escaped.Replace("\r\n", "\r"),
                HL7Enumerator.HL7Message.EscapeOBXCRLF((Example1 + OBXBase64)).Replace("\r\n", "\r"));
            Assert.Equal((Example1 + OBXBase64Escaped + OBXBase64Escaped + ExampleOBX).Replace("\r\n", "\r"),
        ...
        {
            Assert.Equal(Example1 + OBXBase64Escaped.Substring(0,OBXBase64Escaped.Length-1),
                HL7Enumerator.HL7Message.EscapeOBXCRLF(Example1 + OBXBase64.Substring(0,OBXBase64.Length-1)));
            Assert.Equal(Example1 + OBXBase64Escaped + OBXBase64Escaped + ExampleOBX.Substring(0, ExampleOBX.Length - 1),
        ...
        {
            Assert.Equal(Example1,
                HL7Enumerator.HL7Message.EscapeOBXCRLF(Example1));
            Assert.Equal(Example1 + ExampleOBX,
        ...
        public void TestHL7Element_implicit_string_cast_returns_correct_string()
        {
            ...
            Assert.True(element is HL7Enumerator.HL7Element);
            Console.WriteLine(element);
            Assert.Equal(segment, element+"");
            // check null element returns empty string;
            HL7Enumerator.HL7Element nullElement = null;
            Assert.Equal("", "" + nullElement);
        }
